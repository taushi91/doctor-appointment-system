...
<html lang="en-gb" class="no-js">
   ...
   <head>
      ...
      <meta property="og:image" content="assets/images/softexpo_logo.png"/>
               ...
               <div class="row animate" data-anim-type="fadeInUp" data-anim-delay="800">
                  <div class="col-md-12">
                     ...
                     <div class="blog-comments-area col-md-12 organized" style=" text-align: center !important">
                        <div id="respond">
                           <h3 class="exibitor_reg_title color_bg_nohover" style="color:#ffffff;"><i class="fa fa-users fa-fw" aria-hidden="true"></i> Forget Password</h3>
                           <div class="clearfix"></div>
                           <form  method="post" class="form-horizontal exhibitor_reg_form" action="">
                              <div class="clearfix"></div>
                              <div class="form-group">     
                              </div>
                              <div class="form-group">
                                 <label class="col-sm-3 control-label">Email Addess</label>
                                 <div class="col-sm-6">
                                    <input type="text" class="form-control" name="user_name" placeholder="Email or Phone" value="" />
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-sm-6 control-label"></label>
                                 <div class="col-sm-3 control-label"><a href="login.html">Back to Login</a></div>
                              </div>
                              <div class="form-group">
                                 <div class="col-sm-12">
                                    <!-- Do NOT use name="submit" or id="submit" for the Submit button -->
                                    <button type="submit" name="login" value="1" class="view-more-btn btn-register"><i class="fa fa-sign-in"></i> Submit</button>
                                 </div>
                              </div>
                              <div class="clearfix"></div>
                           </form>
   ...
   <!-- Mirrored from www.softexpo.com.bd/visitor/registration by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2018 16:35:01 GMT -->
</html>