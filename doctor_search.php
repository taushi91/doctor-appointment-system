...
if(isset($_POST['area'])){
    $area_id=$_POST['area'];
    $doctor_list=$doctor->doctor_info_by_id_area($_POST['department'],$area_id);
}
else{
    $area_id=0;
    $doctor_list = $doctor->doctor_info_by_id($_POST['department']);
}
//$doctor_list=$doctor->doctor_info_by_id_area($_POST['department'],$area_id);
...
<div class="checkbox checkbox-primary">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12" id="searcharea1_div" style="padding-left: 0px;padding-right: 0px; color: #212121;">
        ...
        <div class="col-xs-6 col-md-6" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
            <input id="area3" class="styled" type="checkbox" name="banani" value="3">
            <label for="area3">Banani</label>
        </div>
        <div class="col-xs-6 col-md-6" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
            <input id="area4" class="styled" type="checkbox" name="Banani DOHS" value="6">
            <label for="area4"> Banani DOHS </label>
        </div>

        <div class="col-xs-6 col-md-6" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
            <input id="area5" class="styled" type="checkbox" name="Banglamotor" value="7">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12" id="second_div" style="padding-left: 0px;padding-right: 0px; color: #212121;">
        ...
        <div class="col-xs-6 col-md-6" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
            ...
            <div class="col-xs-4 col-md-4" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
                <input id="gender1" class="styled" style="position: absolute;" type="checkbox" name="gender" value="1" checked="">
                        <label for="gender1"> Male </label>
            </div>

            <div class="col-xs-4 col-md-4" style="float: left;text-align: left;padding-left: 0px;margin-top: 4px;">
                <input id="gender2" class="styled" style="position: absolute;" type="checkbox" name="gender" value="0" >
                                    ...
                                    <div class="col-lg-12 col-sm-9 form_master_row floating_text">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form_row city_name_input" style="position: relative !important;">
                                                    ...
                                                    <select class="form-control" style="padding-left: 35px !important;" id="city_suggestion" type="text" placeholder="Search cities..." name="departments">
    <option value="" disabled="" selected="" hidden="">Select department</option>
    
    <?PHP while( $departmentData= mysqli_fetch_array($department)){ 
        
        if($departmentData['department_id']==$_POST['department']){
            ?>
    <option value="<?PHP echo $departmentData['department_id'] ?>" selected=""><?PHP echo $departmentData['name'] ?></option>  
                                            ...
                                            <div class="col-lg-12 col-sm-12 doctor_result_div">
                                                <div class="row">
                                                    <div class="col-lg-2 col-sm-2 doctor_search_left_block">
                                                        <img class=" img-responsive" src="assets/image_upload/<?PHP echo $row['image'] ?>" alt="profile pic">
                                                    </div>
...
<script type="text/javascript">
   ...
   document.forms['myform'].elements['departments'].value='<?PHP echo $_POST['department'] ?>'
</script>
